...
class FormVinculoGestorServicoEspacoWidget extends StatefulWidget {
  final VincularGestorServicoAoEspacoController controller;

  const FormVinculoGestorServicoEspacoWidget({super.key, required this.controller});

  @override
  State<FormVinculoGestorServicoEspacoWidget> createState() => _FormVinculoGestorServicoEspacoWidgetState();
}

class _FormVinculoGestorServicoEspacoWidgetState extends State<FormVinculoGestorServicoEspacoWidget> {
          ...
          builder: (context, snapshot) {
            if (snapshot.hasError) {
              ...
              return DropdownButton(
                  ...
                  onChanged: (value) {
                    setState(() {
                      if (value! != widget.controller.gestorServico) {
                        widget.controller.diaSemana = null;
                        _horariosSelecionados.clear();
                        horariosChecked.value.clear();
                      }
                      widget.controller.gestorServico = value;
                    });
                  });
            }
            return Container();
