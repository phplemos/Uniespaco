...
class VincularGestorDeReservaAoEspacoUseCaseImpl
    implements VincularGestorDeReservaAoEspacoUseCase {
  final EspacoRepository _espacoRepository;

  VincularGestorDeReservaAoEspacoUseCaseImpl(this._espacoRepository);
  @override
  Future<Either<Exception, bool>> call(
      {required UsuarioEntity gestorReserva, required EspacoEntity espaco}) {
    return _espacoRepository.vincularGestorReservaEspaco(
        gestorReserva: gestorReserva, espacoEntity: espaco);
  }
}
