...
class ListarGestoresDeReservaVinculadosAosEspacosUseCaseImpl
    implements ListarGestoresDeReservaVinculadosAosEspacosUseCase {
  final EspacoRepository _espacoRepository;

  ListarGestoresDeReservaVinculadosAosEspacosUseCaseImpl(this._espacoRepository);
  @override
