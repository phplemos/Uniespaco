...
class ListarProfessoresCadastradosUseCaseImpl
    implements ListarProfessoresCadastradosUseCase {
  final ProfessorRepository _professorRepository;

  ListarProfessoresCadastradosUseCaseImpl(this._professorRepository);
