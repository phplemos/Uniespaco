...
class PreCadastrarUsuarioUseCaseImpl implements PreCadastrarUsuarioUseCase {
  final UsuarioRepository usuarioRepository;

  PreCadastrarUsuarioUseCaseImpl({required this.usuarioRepository});

  @override
  Future<Either<Exception, bool>> call({required PreCadastroUsuarioEntity preCadastroUsuarioEntity}) {
    return usuarioRepository.preCadastroUsuario(preCadastroUsuarioEntity: preCadastroUsuarioEntity);
  }
}
