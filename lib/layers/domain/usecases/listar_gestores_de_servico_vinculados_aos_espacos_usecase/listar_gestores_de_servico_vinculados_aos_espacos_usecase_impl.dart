...
class ListarGestoresDeServicoVinculadosAosEspacosUseCaseImpl
    implements ListarGestoresDeServicoVinculadosAosEspacosUseCase {
  final EspacoRepository _espacoRepository;

  ListarGestoresDeServicoVinculadosAosEspacosUseCaseImpl(this._espacoRepository);
  @override
